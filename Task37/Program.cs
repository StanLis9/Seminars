...
// int []ProductPairDigit(int[]array)
// {
...
//     return newArray;
// }
// int[] arr = CreateArrayRndInt(5, 1, 5);
// PrintArray(arr);
// int []result = ProductPairDigit(arr);
// Console.WriteLine();
// PrintArray(result);
// Console.WriteLine();
...
int[] arr = CreateArrayRndInt(4, 3, 5);
PrintArray(arr);
Console.WriteLine();
int[] result = NewDigit(arr);
Console.WriteLine();
PrintArray(result);
